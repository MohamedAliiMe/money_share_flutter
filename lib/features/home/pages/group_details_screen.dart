...
import 'package:splitwise_flutter/features/home/pages/expense_list_screen.dart';
...
class _GroupDetailsScreenState extends State<GroupDetailsScreen> {
  ...
  Column _buildBalanceTab() {
    return Column(
      children: [
        buildHeader(
          LocaleKeys.balances.tr(),
          actionText: LocaleKeys.settleUp.tr(),
          onAction: () {},
            ...
            children: [
              if (_balances.isNotEmpty)
                Container(
                  ...
                  child: Text(LocaleKeys.noBalanceYet.tr()),
                )
              else
                Column(
                  children: [
    ...
    return Column(
      children: [
        buildHeader(
          ...
          actionText: LocaleKeys.export.tr(),
          onAction: () {},
          color: AllColors.globalAppColor,
          colorText: AllColors.white,
          hasIcon: true,
        ...
        _expenses.isNotEmpty
            ? Container(
                ...
                child: Text(LocaleKeys.noExpensesYet.tr()),
              )
            : Expanded(
