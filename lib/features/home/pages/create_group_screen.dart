...
class _CreateGroupScreenState extends State<CreateGroupScreen> {
  ...
  final List<Map<String, dynamic>> categories = [
    {"icon": Assets.images.trip, "title": LocaleKeys.categoryTrip.tr()},
    ...
    if (formKey.currentState!.validate()) {
      if (selectedCategory == null) {
        AppAlertDialog.showErrorBar(
          errorMessage: LocaleKeys.selectCategoryValidation.tr(),
        );
        return;
      }
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('${LocaleKeys.createGroupFailed.tr()} $e'),
            ),
          );
        }
      }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(LocaleKeys.createGroup.tr(), style: tr20),
                      IconButton(
                        onPressed: () {},
                  ...
                  /// Categories
                  Text(LocaleKeys.categories.tr(), style: tr18),
